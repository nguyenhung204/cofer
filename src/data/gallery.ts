...
import volunteerDay from '../assets/cofer-volunteer-2.jpg'
export const gallery: GalleryItem[] = [
  ...
  { id: 5, alt: 'Sinh viên COFER hỗ trợ người dân khám sức khỏe', image: communityCare, span: 'md:col-span-2' },
  { id: 6, alt: 'Sinh viên COFER tham gia ngày hội tình nguyện', image: volunteerDay, span: 'md:col-span-2' },
]
