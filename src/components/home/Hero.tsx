...
export function Hero() {
  return <section id="top" className="relative overflow-hidden bg-[#063f82]">
    <div className="page-shell relative grid min-h-[500px] lg:min-h-[570px] lg:grid-cols-[45%_55%]">
      <div className="relative z-10 flex items-center py-12 sm:py-16 lg:-translate-y-5 lg:py-0">
    ...
    <span className="pointer-events-none absolute bottom-0 left-0 h-1 w-[42%] bg-[#e1252d]" />
  </section>
}
